...
function Cart() {
    const { count, getCartContext, removeItemContext, clearAllContext, increaseQtyContext, decreaseQtyContext } = useContext(CartContext);
    ...
    const removeItem = async (productId) => {
        const result = await removeItemContext(productId);
        return result;
    }

    const clearAll = async () => {
        const result = await clearAllContext();
        return result;
    }

    const increaseQty = async (productId) => {
        const result = await increaseQtyContext(productId);
        return result;
    }

    const decreaseQty = async (productId) => {
        const result = await decreaseQtyContext(productId);
        return result;
    }
